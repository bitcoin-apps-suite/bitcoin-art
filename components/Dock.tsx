...
const Dock: React.FC = () => {
  ...
  const dockApps: DockApp[] = [
    ...
    { name: 'Bitcoin Exchange', icon: TrendingUp, color: 'text-emerald-500', url: 'https://bitcoin-exchange.vercel.app' },
    ...
    { name: 'Bitcoin Art', icon: Palette, color: 'text-pink-500', current: true },
    ...
    { name: 'Bitcoin OS', icon: Building2, color: 'text-orange-500', url: 'https://bitcoin-os.vercel.app' },
  ];
